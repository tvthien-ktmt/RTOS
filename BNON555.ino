...
void handleRoot() {
  ...
  html += "svg+=\"<text x='43' y='14' text-anchor='middle' fill='#666' "
          "font-size='10' font-weight='700'>N</text>\";";
  html += "svg+=\"<circle cx='43' cy='43' r='36' fill='none' stroke='#ccc' "
          "stroke-width='1'/>\";";
  html += "svg+=\"<path d='M43 18 L48 34 L43 30 L38 34 Z' fill='#4285f4' "
          "transform='rotate(\"+heading+\",43,43)'/>\";";
  html += "svg+=\"<path d='M43 20 L46 32 L43 29 L40 32 Z' fill='#ea4335' "
          "opacity='0.7' transform='rotate(\"+bearing+\",43,43)'/>\";";
